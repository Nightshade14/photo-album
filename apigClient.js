...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://qjup4ril4e.execute-api.us-east-1.amazonaws.com/v4';
    ...
    apigClient.photosPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['key', 'bucket', 'x-amz-meta-customLabels', 'Content-Type'], ['body']);
        ...
        var photosPutRequest = {
            ...
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['key', 'bucket', ]),
            body: body
        };
